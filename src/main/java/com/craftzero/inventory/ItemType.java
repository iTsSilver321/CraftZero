...
public enum ItemType {
    ...
    TALL_GRASS(31, BlockType.TALL_GRASS),
    ...
    WHITE_WOOL(35, BlockType.WHITE_WOOL),
    ...
    GOLDEN_APPLE(322, 1, 11, 0),
    SIGN(323, 1, BlockType.STANDING_SIGN, 10, 2),
    ...
    static {
        for (ItemType type : values()) {
            ...
            if (type.placedBlock != null) {
                ItemType previousBlock = BY_BLOCK.put(type.placedBlock, type);
                if (previousBlock != null) {
                    throw new IllegalStateException(
                            "Duplicate block item for " + type.placedBlock + ": "
                                    + previousBlock.name() + " and " + type.name());
                }
            }
        }
    }
    ...
    public float[] getTextureCoords(int face) {
        return placedBlock != null ? placedBlock.getTextureCoords(face) : new float[] { 0, 0, 0, 0 };
    }
